...
butt_1 = KeyboardButton(text='Информация')
butt_2 = KeyboardButton(text='Рассчитать')
keyB.add(butt_1)
keyB.add(butt_2)
keyB.resize_keyboard
# kb.insert kb.row
...
async def consol_command(messeage):
    await messeage.answer('Привет! Я бот помогающий твоему здоровью.', reply_markup=keyB)
